...
git clone https://github.com/Bitcoin-OLD/gitian.sigs.git
```
...
Output from `gbuild` will look something like
    ...
    From https://github.com/Bitcoin-OLD/Bitcoin-OLD
...
cd /some/root/path/
git clone https://github.com/bitcoin-core/bitcoinold-detached-sigs.git
